...
- Green baseline: `bin/rails test` (239 runs) and `bin/rails test:system` (1 run) must stay green.
...
- When porting or questioning legacy behavior, read `master:` first, then keep/adjust the Rails 8
  tests accordingly.
